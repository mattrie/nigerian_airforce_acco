...
if (isset($_POST['Submit'])) {
    ...
    $old_occuopant = $_SESSION['store_occupant'];
   
    if ($id == "") {
        echo "<script type='text/javascript'> $(document).ready(function(){ 
            swal({
                     title: 'Not Allowed!',
                     text: 'You must search an accomodation to update',
                     icon: 'warning',
                    buttons: {
        ...
        if ($old_occuopant != $occupant) {
            $history_submit = mysqli_query($connect, "INSERT INTO  accomodation_history (name, fetch_id) VALUES ('$occupant', '$id')");
            // echo "Error: " . mysqli_error($connect);
        }
       

        $sql_statement = "UPDATE accomodation SET block = '$block', flat_no = '$flat_no', room = '$room', occupant = '$occupant', block_leader = '$block_leader', bq = '$bq' WHERE id = '$id'";
       ...
       swal({
                title: 'Success!',
                text: '$block | Flat No: $flat_no | Room: $room has been successfully updated',
                icon: 'success',
               buttons: {
                   confirm : {text:'Ok',className:'sweet-orange'},
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Edit Accomodation</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <!-- <form action="" method="post">
                                                              ...
                                                              <div class="row mb-5">
                                                                <div class="col-sm-3">
                                                                    <label for="block">Search Block:</label>
                                                                    <input list="dl1" name="block" autocomplete="off" class="form-control">
                                                                    <datalist Id="dl1">
                                                                        <?php  
                                                                         $sql_block = mysqli_query($connect, "SELECT DISTINCT block FROM accomodation ORDER BY block ASC");
                                                                         while ($row = mysqli_fetch_array($sql_block)) {?>
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <label for="Flat No">Search Flat No:</label>
                                                                    <input list="dl2" name="flat_no" autocomplete="off" class="form-control">
                                                                    <datalist Id="dl2">
                                                                        <?php  
                                                                         $sql_block2 = mysqli_query($connect, "SELECT DISTINCT flat_no FROM accomodation ORDER BY block ASC");
                                                                         while ($row = mysqli_fetch_array($sql_block2)) {?>
                                                                            <option value="<?php echo $row['flat_no']; ?>"></option>
                                                                         <?php } ?>                                                                       
                                                                    </datalist>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-3">
                                                                    ...
                                                                    <input list="dl3" name="room" autocomplete="off" class="form-control">
                                                                    <datalist Id="dl3">
                                                                        <?php  
                                                                         $sql_block3 = mysqli_query($connect, "SELECT DISTINCT room FROM accomodation ORDER BY block ASC");
                                                                         while ($row = mysqli_fetch_array($sql_block3)) {?>
                                                                ...
                                                                <div class="col-sm-3">
                                                                   <button type="submit" name="src_block" class="btn btn-warning mt-3">SEARCH</button>
                                                                </div>
                                                    ...
                                                    <?php  
                                                    $get_block = $get_flatno = $get_room = $occupant = $block_leader = $bq ="";
                                                    if(isset($_POST['src_block'])){
                                                        $block = $_POST['block'];
                                                        $flat_no = $_POST['flat_no'];
                                                        $room = $_POST['room'];
                                                       
                                                        
                                                        $sql_search = mysqli_query($connect, "SELECT * FROM accomodation WHERE block = '$block' AND flat_no = '$flat_no' AND room = '$room'");
                                                        // echo "Error: " . mysqli_error($connect);
                                                        while ($row = mysqli_fetch_array($sql_search)) {
                                                            $id = $row['id'];
                                                            $get_block = $row['block'];
                                                            $get_flatno = $row['flat_no'];
                                                            $get_room = $row['room'];
                                                            $occupant = $row['occupant'];
                                                            $block_leader = $row['block_leader'];
                                                            $bq = $row['bq'];
                                                        }
                                                        $_SESSION['store_occupant'] = $occupant;

                                                        if ($get_block == "") {
                                                            echo "<script type='text/javascript'> $(document).ready(function(){ 
                                                                swal({
                                                                         title: 'Invalid!',
                                                                         text: '$block | Flat No: $flat_no | Room: $room does not exist in the database',
                                                                         icon: 'error',
                                                                        buttons: {
                                                                            confirm : {text:'Ok',className:'sweet-orange'},
                                                    ...
                                                    if(isset($_GET['identity'])){
                                                        ...
                                                        $sql_search = mysqli_query($connect, "SELECT * FROM accomodation WHERE id = '$identity'");
                                                        // echo "Error: " . mysqli_error($connect);
                                                        while ($row = mysqli_fetch_array($sql_search)) {
                                                            $id = $row['id'];
                                                            $get_block = $row['block'];
                                                    ...
                                                    ?>
                                                        ...
                                                        <form action="" method="POST"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" value="<?php echo $get_block?>" name="block" class="form-control"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" value="<?php echo $get_flatno?>" name="flat_no"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" value="<?php echo $get_room?>" class="form-control"
                                                                        placeholder="enter Room No." name="room"
                                                                        required="">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Current
                                                                    Occupant:</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" value="<?php echo $occupant?>"
                                                                        placeholder="enter Current Occupant"
                                                                        name="occupant">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Block
                                                                    Leader:</label>
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text" value="<?php echo $block_leader?>"
                                                                        placeholder="enter Block Leader"
                                                                        name="block_leader" maxlength="50">
                                                                </div>
                                                            </div>


                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">BQ (If
                                                                    Any):</label>
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text" value="<?php echo $bq ?>"
                                                                        placeholder="enter BQ if any" name="bq"
                                                                        maxlength="50">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10 mx-auto">
                                                                    <input style="" type="submit" name="Submit"
                                                                        class="btn btn-success button-distance"
                                                                        value="Update" />
                                                                    <a style="margin-left:70px;" class="btn btn-dark"
                                                                        href="edit_accomodation">Reset</a>
                                                                </div>
