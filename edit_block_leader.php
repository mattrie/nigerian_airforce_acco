...
if (isset($_POST['Submit'])) {
    ...
    $sql_statement = "UPDATE block_assign SET name = '$name', svn = '$svn', unit = '$unit', block = '$block', phone = '$phone', images = '$target_file', username = '$username', password = '$pass' WHERE id = '$id'";
    ...
    if ($result == true) {
        echo "<script type='text/javascript'> $(document).ready(function(){ 
                swal({
                         title: 'Success!',
                         text: '$name has been successfully assigned to $block. Updated',
                         icon: 'success',
                        buttons: {
        ...
        echo "<script>alert('Not submitted. DB error is')</script>";
    }
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Block Leader Edit</h5>
                                            <p class="m-b-0">Edit Block Leader</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <form action="" method="POST" enctype="multipart/form-data">
                                                            <center>
                                                                <div class="input-group mb-3">
                                                                    <input type="text" class="form-control"
                                                                        id="autocomplete_leader" name="srch"
                                                                        placeholder="Search BLock Leader" required="">
                                                            ...
                                                            <?php
                                                            //          session_start();
                                                            $id = $name = $svn = $unit = $block = $username = $images = "";
                                                            if (isset($_POST['btnsrch'])) {

                                                                $get_name = $_POST['srch'];
                                                                $sql_state = "SELECT * FROM block_assign WHERE block = '$get_name'";
                                                        ...
                                                        <form action="" method="POST"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control"
                                                                        placeholder="enter SVN" name="svn" value="<?php echo $svn?>"
                                                                        maxlength="50"
                                                                        style="text-transform: uppercase;" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" value="<?php echo $unit?>"
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Block
                                                                    Assigned:</label>
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text" value="<?php echo $block?>"
                                                                        placeholder="enter Block Assigned" name="block"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                   <input  class="form-control" type="number" placeholder="enter Phone" value="<?php echo $phone?>" name="phone"  maxlength="50" required>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10 mx-auto">
                                                                    ...
                                                                    <a style="margin-left:70px;" class="btn btn-dark"
                                                                        href="edit_block_leader">Reset</a>
                                                                </div>
...
//         }
        ...
        <script type='text/javascript'>
            $(function () {
                ...
                $("#autocomplete_leader").autocomplete({
                    source: function (request, response) {

                        $.ajax({
                            url: "autocomplete_leader.php",
                            type: 'post',
                            dataType: "json",
                            data: {
                                search: request.term
                    ...
                    select: function (event, ui) {
                        $('#autocomplete_leader').val(ui.item.label); // display the selected text
